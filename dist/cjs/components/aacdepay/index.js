...
*/
class AACDepay extends component_1.Tube {
    constructor() {
        let AACPayloadType;
        let hasHeader;
        const incoming = messageStreams_1.createTransform(function (msg, encoding, callback) {
            if (msg.type === message_1.MessageType.SDP) {
                ...
                rtp_1.payloadType(msg.data) === AACPayloadType) {
                parser_1.parse(msg, hasHeader, this.push.bind(this));
                callback();
            }
            else {
