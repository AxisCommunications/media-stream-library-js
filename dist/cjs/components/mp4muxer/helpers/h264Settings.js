...
const spsparser_1 = require("./spsparser");
const PROFILE_NAMES = {
    66: 'Baseline',
    77: 'Main',
    100: 'High',
...
exports.h264Settings = (media, date, trackId) => {
    /*
    ...
    const parsedSps = new spsparser_1.SPSParser(sps[0].buffer).parse();
    ...
    return {
        mediaHeaderBox: new isom_1.Box('vmhd'),
        sampleEntryBox: new isom_1.Container('avc1', {
