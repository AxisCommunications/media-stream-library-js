...
var aacEncodingName = function (audioConfigBytes) {
    ...
    var audioType = AUDIO_OBJECT_TYPE_NAMES[audioObjectType] || "AAC (" + audioObjectType + ")";
...
export var aacSettings = function (media, date, trackId) {
    /*
