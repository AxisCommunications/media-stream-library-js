...
export var count = function (buffer) {
    return buffer[0] & 0x1f;
};
export var packetType = function (buffer) {
    return buffer[1];
};
export var length = function (buffer) {
...
export var SR = {
    packetType: 200,
    syncSource: function (buffer) {
        return buffer.readUInt32BE(4);
    },
    ntpMost: function (buffer) {
        return buffer.readUInt32BE(8);
    },
    ntpLeast: function (buffer) {
        return buffer.readUInt32BE(12);
    },
    rtpTimestamp: function (buffer) {
        return buffer.readUInt32BE(16);
    },
    sendersPacketCount: function (buffer) {
        return buffer.readUInt32BE(20);
    },
    sendersOctetCount: function (buffer) {
