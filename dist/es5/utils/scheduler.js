...
var Scheduler = /** @class */ (function () {
     ...
     * @memberof Scheduler
     */
    function Scheduler(clock, handler, tolerance) {
     ...
     * @memberof Scheduler
     */
    Scheduler.prototype.init = function (ntpPresentationTime) {
     ...
     * @memberof Scheduler
     */
    Scheduler.prototype.suspend = function () {
        clearTimeout(this._nextPlay);
     ...
     * @memberof Scheduler
     */
    Scheduler.prototype.run = function (newMessage) {
        var _this = this;
        clearTimeout(this._nextRun);
        ...
        if (timeToPresent < -this._tolerance) {
            ...
            clearTimeout(this._nextPlay);
            this._clock.pause();
            this._nextPlay = window.setTimeout(function () { return _this._clock.play(); }, -timeToPresent);
        }
            ...
            this._nextRun = window.setTimeout(function () { return _this.run(undefined); }, timeToPresent);
        }
    };
    return Scheduler;
}());
