...
export const count = (buffer: Buffer) => {
  return buffer[0] & 0x1f
}

export const packetType = (buffer: Buffer) => {
  return buffer[1]
}
...
export const SR = {
  ...
  syncSource: (buffer: Buffer) => {
    return buffer.readUInt32BE(4)
  },

  ntpMost: (buffer: Buffer) => {
    return buffer.readUInt32BE(8)
  },

  ntpLeast: (buffer: Buffer) => {
    return buffer.readUInt32BE(12)
  },

  rtpTimestamp: (buffer: Buffer) => {
    return buffer.readUInt32BE(16)
  },

  sendersPacketCount: (buffer: Buffer) => {
    return buffer.readUInt32BE(20)
  },

  sendersOctetCount: (buffer: Buffer) => {
