...
describe('h264 handler', () => {
  ...
  it('parses a single NALU packet', () => {
    ...
    const remaining = h264depay(Buffer.alloc(0), {data: singleNalu}, callback)
    ...
    expect(msg.type).toEqual(ELEMENTARY)
