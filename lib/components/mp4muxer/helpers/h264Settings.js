...
const SpsParser = require('./spsparser')
...
const h264Settings = (media, date, trackId) => {
  ...
  return {
    ...
    defaultFrameDuration: media.framerate > 0
      ? (Number(media.rtpmap.clockrate) / Number(media.framerate)) || FALLBACK_FRAME_DURATION
