(function () {
	...
	/*
	This example works with an ES5 version of the media stream library. The purpose of this example is to demonstrate Internet explorer (IE) functionality.
	(Unfortunately, some of us still have to 'support' it :( )
	...
	*/
	...
	function authorize(host) {
		...
		auth.open("GET", 'http://' + host + '/axis-cgi/usergroup.cgi', false/*, username, password*/);
		auth.send(null);
	}
